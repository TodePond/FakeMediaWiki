...
export const categories: PrototypeTypes.CategoryDefinition[] = [
	...
	},
	{
		id: "documentation",
		name: "Documentation",
		description: "Generated and interactive documentation for FakeWiki and wiki signals.",
	},
	{
		id: "api",
		name: "API",
...
export const prototypeMetadata: PrototypeTypes.PrototypeDefinition<"prototype" | "variants">[] = [
	...
	},
	{
		type: "prototype",
		id: "ApiPlayground",
		name: "FakeWiki playground",
		description: "Sandbox for every FakeWiki method.",
		category: "documentation",
		wrapper: "Fullscreen",
		title: "FakeWiki playground",
		status: "updated",
		featured: true,
	},
	{
	...
	{
		type: "prototype",
		id: "FakeWikiReference",
		name: "FakeWiki reference",
		description: "Read-only full API reference (generated from TSDoc; same as AGENTS.md).",
		category: "documentation",
		wrapper: "Fullscreen",
		title: "FakeWiki reference",
		status: "new",
		featured: true,
	},
	{
