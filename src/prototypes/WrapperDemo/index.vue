	...
	<div class="wrapper-demo">
		...
		<div class="wrapper-demo-block">
			...
			<p>
				...
				might want to see how a component looks when surrounded by all the usual surrounding
				Wikipedia UI. On the other hand, you might want to examine or try out a component in
				a vacuum... to really focus in on how it works / looks / feels / and so on.
			</p>
		</div>
		<div class="wrapper-demo-block">
			<h2>Warning</h2>
			<p>
				...
				funky when viewed in other wrappers. For example, this prototype doesn't work well
				with the Fullscreen wrapper. It ends up hugging the edges of the screen too much.
			</p>
		</div>
		<div class="wrapper-demo-block">
			<h2>Testing overflow</h2>
			<p>
				The following paragraphs are placeholder copy so we can test scrolling and overflow
				within the Mobile wrapper. When the content is taller than the phone screen, the
				middle section should scroll while the top and bottom chrome stay fixed.
			</p>
			<p>
			...
			<p>
				...
				maiores alias consequatur aut perferendis doloribus asperiores repellat. Curabitur
				pretium tincidunt lacus. Nulla facilisi. Vivamus convallis tempor magna. Aenean
				velit nunc, faucibus id molestie in, molestie ut magna.
			</p>
			<p>
